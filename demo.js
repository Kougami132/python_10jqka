...
var TOKEN_SERVER_TIME = 1685855000.705; !
function(n, t) { !
    function() {
        var r, e, a;
        r = e = a = n;
        ...
        function(n) {
            ...
            function C() {
                ...
                r = u[88];
                if (i = m(), i) f = a[65][o];
                else if (l[at(e[66])][at(e[67], a[68])]) try {
        ...
        var qn = function() {
            ...
            return l[e[104]][w + m + I + u] = function() {
                for (var a = e[105], u = this[a + y], c = [], s = -e[0], v = o[2], f = u[r[56]]; v < f; v++) for (var l = this[v], p = u[v], d = s += p; c[d] = l & parseInt(t[77], n[78]), --p != r[52];)--d,
        ...
        function(n) {
            ...
            function g(n, a, o, i, u) {
                for (var c = s[13], v = r[87], f = n[s[111]]; a < f;) o[i++] = n[a++] ^ u & parseInt(c + v + t + _, r[88]),
            ...
            for (var m = at(u[115], s[116]), I = {},
            y = u[2]; y < parseInt(i + A, e[93]); y++) I[m.charAt(y)] = y;
            function O(n) {
                var t, r, e;
                t = r = e = s;
                var o, i, u;
            ...
            function D(n) {
                var t = O(n);
                if (rn, p, t[r[52]] != h) return error = T + B + l,
                void 0;
                var a = t[c[0]],
                o = [];
        ...
        function(n) {
            ...
            function B(n) {
                ...
                if (u = s = v = r, typeof n === ot(s[109], sn) && n[Wn(y, a[136], s[110])]) try {
                    ...
                    case parseInt(a[131], t[122]) : break;
                    case parseInt(v[111], s[78]) : top[e[138]][v[112]] = n[t[139]];
                        break;
                    case parseInt(u[113], e[122]) : top[o + i + N][e[140]] = n[s[114]];
                        break;
                    default:
                        break
                    }
            ...
            function G(n) {
                ...
                var o, i, u;
                o = i = u = r;
                for (var c = u[52], v = a[2], f = n[o[56]]; v < f; v++) c = (c << a[123]) - c + n.charCodeAt(v),
                c >>>= o[52];
                return c
            }
            function K(n) {
